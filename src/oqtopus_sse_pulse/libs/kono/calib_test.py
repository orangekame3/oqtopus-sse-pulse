...
from qubex.experiment.mixin.calibration_mixin import CalibrationMixin, CALIBRATION_SHOTS
...
from qubex.experiment.experiment_constants import HPI_DURATION, HPI_RAMPTIME, PI_DURATION, PI_RAMPTIME, CALIBRATION_SHOTS
...
# def calibrate(ex: CustomExperiment, calib_readout: bool = False):
    try:
        ...
        # readout_frequencies = ex.calibrate_readout_frequency(targets=ex.qubit_labels)           # obtain readout frequencies
